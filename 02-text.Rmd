...
In this part, we are going to go the functions as applied to a variable. For this purpose, we are going to use builtin datasets in R. You can view the available datasets by
```{r}
data()
```
